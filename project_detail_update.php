...
<?php
  ...
  if(isset($_REQUEST['Project_detail_id']) && !empty($_REQUEST['Project_detail_id'])) {
    $editId = $_REQUEST['Project_detail_id'];
...
<h2>
    <a href="project_detail.php" class="col-md-12 text-right" style="float:center;">Back to page</a>
  </h2>
...
<div class="container">
  <h2>Update Project Detail Record Here</h2>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="form-group">
      ...
      <input type="date"  name="date" class="form-control" value="<?php echo $customer['date']; ?>" placeholder="Enter Date" required>
    </div>
        <div class="form-group">
      <label for="">Attended By:</label>
      <input type="text" name="attended_by" class="form-control" value="<?php echo $customer['attended_by']; ?>" placeholder="Enter Number" required>
    </div>
    <div class="form-group">
      <label for="">Detail:</label>
      <input type="text" class="form-control" value="<?php echo $customer['detail']; ?>" placeholder="Enter Detail" name="detail" required>
    </div>
