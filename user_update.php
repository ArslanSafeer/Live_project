...
<h2>
    <a href="user.php" class="col-md-12 text-right" style="float:center;">Back to page</a>
  </h2>
...
<div class="container">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="form-group">
      ...
      <input type="text"  name="user_name" class="form-control" value="<?php echo $customer['user_name']; ?>" placeholder="Enter Name" required>
    </div>
        <div class="form-group">
      <label for="">User Email:</label>
      <input type="email" name="user_email" class="form-control" value="<?php echo $customer['user_email']; ?>" placeholder="Enter Email" required>
    </div>
