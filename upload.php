  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="page-content">
        <!-- Page Header-->
<h2>
    <a href="project_detail.php"  class="col-md-12 text-right">Back to page</a>
  </h2>
...
<div class="container">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="form-group">
      <label for=""></label>
      <input type="hidden" name="Project_detail_id" class="form-control" value="<?php echo $_GET['Project_detail_id']; ?>">
    </div>
        <div class="form-group">
      <label for="">Upload Image:</label>
      <input type="file" name="image_path[]" class="form-control" multiple required>
    </div>
    <input type="submit" name="UploadBtn" class="btn btn-info" value="Upload">
  </form>
        </div>
...
$image_name=$_FILES['image_path']['name'][$i];
$image_tmp_name=$_FILES['image_path']['tmp_name'][$i];
$image_type=$_FILES['image_path']['type'][$i];
$image_size=$_FILES['image_path']['size'][$i];
$folder="images/";
...
if(strtolower($image_type)=="image/jpg" || strtolower($image_type)=="image/png" || strtolower($image_type)=="image/jpeg" ){
  ...
  if ($image_size<1000000){
    ...
    $query="INSERT into images(image_path,Project_detail_id) values ('$folder','$Project_detail_id')";
  ...
  else
  {
       ...
       echo "<script>alert('images size should be less then or equal to 1 MB'...)</script>";
          exit();
}
  ...
  echo "<script>alert('images formate not allowed'...)</script>";
  exit();
...
<br><br>
 <div id="display-image">
        <?php
        $conn = mysqli_connect("localhost", "root", "", "live_project");
        $query = " select * from images";
        $result = mysqli_query($conn, $query);
 
        while ($data = mysqli_fetch_assoc($result)) {
        ?>
            <td><img src=" <?php echo $data['image_path']; ?>" height="200px" width="200px"></td>
