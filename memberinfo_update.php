...
<?php
  ...
  if(isset($_REQUEST['project_members_id']) && !empty($_REQUEST['project_members_id'])) {
    $editId = $_REQUEST['project_members_id'];
...
<h2>
    <a href="member_info.php"  class="col-md-12 text-right">Back to page</a>
  </h2>
...
<div class="container">
  <h2>Update Project Member Record Here</h2>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="form-group">
      ...
      <input type="text" name="phone_no" class="form-control" value="<?php echo $customer['phone_no']; ?>" placeholder="Enter Number" required>
    </div>
    <div class="form-group">
      <label for="">Email:</label>
      <input type="email" class="form-control" value="<?php echo $customer['email']; ?>" placeholder="Enter Email" name="email" required>
    </div>
