...
$result =mysqli_query($this->dbh,"SELECT Username FROM admin WHERE Username='$uname'");
return $result;
...
// Function for registration
	...
	{
	$ret=mysqli_query($this->dbh,"insert into admin(FullName,Username,UserEmail,Password) values('$fname','$uname','$uemail','$pasword')");
	return $ret;
	}
// Function for signin
